...
#define FIRE_PIN  D14 // spinner motors for launching ball - YELLOW
#define FEED_PIN  D15 // belt driver motor - WHITE
...
int motPitch_EN = D8; // when gun barrel points down, negative pitch angle on IMU and positive
                      // corrective output
int motPitch_IN1 = D9;
int motPitch_IN2 = D10;
